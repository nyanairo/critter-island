...
export const SPECIES = {
  leaf: {
    ...
    name: "Leafy",
    label: "Leaf",
    description: "A calm forest critter with clever growth.",
  ...
  flame: {
    ...
    name: "Fairo",
    label: "Flame",
    description: "A bold critter that wins with force and speed.",
  ...
  aqua: {
    ...
    name: "Aquo",
    label: "Aqua",
    description: "A steady water critter with smart defenses.",
