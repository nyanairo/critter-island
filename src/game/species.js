...
// Each species declares: base stats, growth tendency, and 3 candidate starting moves.
...
export const SPECIES = {
  leaf: {
    ...
    name: "リーフィ",
    label: "葉のしずく",
    description: "穏やかで、賢さと耐久が伸びる森のクリッター。",
  ...
  flame: {
    ...
    name: "ファイロ",
    label: "炎のかけら",
    description: "気性が荒く、ちからとすばやさで押す赤いクリッター。",
